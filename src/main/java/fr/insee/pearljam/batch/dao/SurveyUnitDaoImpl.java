...
public class SurveyUnitDaoImpl implements SurveyUnitDao {
	...
	public List<String> getAllSurveyUnitByCampaignId(String campaignId) {
		...
		return pilotageJdbcTemplate.queryForList(qString, new Object[] {campaignId}, String.class);
	}
	
	public SurveyUnitType getSurveyUnitById(String surveyUnitId) {
		String qString = "SELECT * FROM survey_unit WHERE id=?";
		return pilotageJdbcTemplate.queryForObject(qString, new Object[] {surveyUnitId}, new SurveyUnitTypeMapper());
	}
	...
	public String getSurveyUnitInterviewerAffectation(String surveyUnitId) {
		...
		return pilotageJdbcTemplate.queryForObject(qString, new Object[] {surveyUnitId}, String.class);
	}
	...
	public long getAddressIdBySurveyUnitId(String surveyUnitId) {
		...
		return pilotageJdbcTemplate.queryForObject(qString, new Object[] { surveyUnitId }, Long.class);
	}
