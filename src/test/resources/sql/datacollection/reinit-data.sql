...
INSERT INTO public.campaign(id, label, sensitivity) VALUES
  ...
  ('VQS2022X00', 'Everyday life and health survey 2022', 'NORMAL'),
...
INSERT INTO public.metadata(id, value, campaign_id) VALUES
  ...
  ('0fb58fa2-e26a-4a68-9ca7-6ec63bb2fb71', '{}', 'VQS2022X00'),
...
INSERT INTO public.required_nomenclature(id_required_nomenclature, code) VALUES
  ...
  ('VQS2022X00', 'cities2019'),
  ('VQS2022X00', 'regions2019'),
...
INSERT INTO public.interrogation (id, survey_unit_id, campaign_id, questionnaire_model_id) VALUES
  ...
  ('0c83fb82-0197-7197-8e8c-a6ce2c2dbdc0', '20', 'VQS2022X00', 'VQS2022X00'),
  ('0c83fb82-0197-7197-8e8c-a6ce2c2dbdc1', '21', 'VQS2022X00', 'VQS2022X00'),
  ('0c83fb82-0197-7197-8e8c-a6ce2c2dbdc2', '22', 'VQS2022X00', 'VQS2022X00'),
  ('0c83fb82-0197-7197-8e8c-a6ce2c2dbdc3', '23', 'VQS2022X00', 'VQS2022X00'),
...
INSERT INTO public.data (id, value, interrogation_id, encrypted) VALUES
('6cb4378d-aa70-4add-bb61-1f2fdc86dfbb',
 '{"EXTERNAL": {}, "CALCULATED": {}, "COLLECTED": {"TEXT": {"COLLECTED": "super réponse11"}}}'::jsonb,
 '0c83fb82-0197-7197-8e8c-a6ce2c2dbdb1',
 0),  -- 11

('cf72a231-b40f-4ffa-9834-bf4e40bf85ac',
 '{"EXTERNAL": {}, "CALCULATED": {}, "COLLECTED": {"TEXT": {"COLLECTED": "super réponse12"}}}'::jsonb,
 '0c83fb82-0197-7197-8e8c-a6ce2c2dbdb2',
 0),  -- 12

('f63bbfbe-9926-48ae-8d04-421296a40634',
 '{"EXTERNAL": {}, "CALCULATED": {}, "COLLECTED": {"TEXT": {"COLLECTED": "super réponse13"}}}'::jsonb,
 '0c83fb82-0197-7197-8e8c-a6ce2c2dbdb3',
 0),  -- 13

('8e3b28cc-74b1-4391-8359-c495538129b7',
 '{"EXTERNAL": {}, "CALCULATED": {}, "COLLECTED": {"TEXT": {"COLLECTED": "super réponse14"}}}'::jsonb,
 '0c83fb82-0197-7197-8e8c-a6ce2c2dbdb4',
 0),  -- 14

('e9e97450-ef9c-4f49-9375-adf11b6a158b',
 '{"EXTERNAL": {}, "CALCULATED": {}, "COLLECTED": {"TEXT": {"COLLECTED": "super réponse20"}}}'::jsonb,
 '0c83fb82-0197-7197-8e8c-a6ce2c2dbdc0',
 0),  -- 20

('42dc1400-0a36-4c20-8742-115e22c42369',
 '{"EXTERNAL": {}, "CALCULATED": {}, "COLLECTED": {"TEXT": {"COLLECTED": "super réponse21"}}}'::jsonb,
 '0c83fb82-0197-7197-8e8c-a6ce2c2dbdc1',
 0),  -- 21

('4540afba-ee51-42e4-bf74-d2346d813e89',
 '{"EXTERNAL": {}, "CALCULATED": {}, "COLLECTED": {"TEXT": {"COLLECTED": "super réponse22"}}}'::jsonb,
 '0c83fb82-0197-7197-8e8c-a6ce2c2dbdc2',
 0),  -- 22

('757170c2-b2d5-4c71-85c1-61988b36e416',
 '{"EXTERNAL": {}, "CALCULATED": {}, "COLLECTED": {"TEXT": {"COLLECTED": "super réponse23"}}}'::jsonb,
 '0c83fb82-0197-7197-8e8c-a6ce2c2dbdc3',
 0),  -- 23

('757170c2-b2d5-4c71-85c1-61988b36e417',
 '{"EXTERNAL": {}, "CALCULATED": {}, "COLLECTED": {"TEXT": {"COLLECTED": "super réponse su-test-diff-data"}}}'::jsonb,
 '0c83fb82-0197-7197-8e8c-a6ce2c2dbdf0',
 0),  -- su-test-diff-data

('757170c2-b2d5-4c71-85c1-61988b36e418',
 '{"EXTERNAL": {}, "CALCULATED": {}, "COLLECTED": {"TEXT": {"COLLECTED": "super réponse su-test-diff-without-collected-data"}}}'::jsonb,
 '0c83fb82-0197-7197-8e8c-a6ce2c2dbdf1',
 0),  -- su-test-diff-without-collected-data

('27abfaed-187a-44ab-8287-af08f3bd7158',
 '{"EXTERNAL": {}, "CALCULATED": {}, "COLLECTED": {"TEXT": {"COLLECTED": "super réponse LOG2021X11Web-01"}}}'::jsonb,
 '0c83fb82-0197-7197-8e8c-a6ce2c2dbdd1',
 0),  -- LOG2021X11Web-01

('c118114a-c0be-462d-9fe9-604436bea20a',
 '{"EXTERNAL": {}, "CALCULATED": {}, "COLLECTED": {"TEXT": {"COLLECTED": "super réponse LOG2021X11Web-02"}}}'::jsonb,
 '0c83fb82-0197-7197-8e8c-a6ce2c2dbdd2',
 0),  -- LOG2021X11Web-02

('df044ba3-9abb-451e-9e4d-75ba98ace5e6',
 '{"EXTERNAL": {}, "CALCULATED": {}, "COLLECTED": {"TEXT": {"COLLECTED": "super réponse LOG2021X11Web-03"}}}'::jsonb,
 '0c83fb82-0197-7197-8e8c-a6ce2c2dbdd3',
 0),  -- LOG2021X11Web-03

('fdc43238-cf8e-4a55-ad49-14ea8152728d',
 '{"EXTERNAL": {}, "CALCULATED": {}, "COLLECTED": {"TEXT": {"COLLECTED": "super réponse LOG2021X11Tel_01"}}}'::jsonb,
 '0c83fb82-0197-7197-8e8c-a6ce2c2dbde1',
 0),  -- LOG2021X11Tel_01

('fa0a7a90-0324-429f-837b-ad06b79cfd7d',
 '{"EXTERNAL": {}, "CALCULATED": {}, "COLLECTED": {"TEXT": {"COLLECTED": "super réponse LOG2021X11Tel_02"}}}'::jsonb,
 '0c83fb82-0197-7197-8e8c-a6ce2c2dbde2',
 0),  -- LOG2021X11Tel_02

('d51e29b9-b27b-4159-957c-6bb54d811a20',
 '{"EXTERNAL": {}, "CALCULATED": {}, "COLLECTED": {"TEXT": {"COLLECTED": "super réponse LOG2021X11Tel_03"}}}'::jsonb,
 '0c83fb82-0197-7197-8e8c-a6ce2c2dbde3',
 0),  -- LOG2021X11Tel_03

('b78366f8-8653-448a-8754-53a3135a2130',
 '{"EXTERNAL": {}, "CALCULATED": {}, "COLLECTED": {"TEXT": {"COLLECTED": "super réponse1"}}}'::jsonb,
 '0c83fb82-0197-7197-8e8c-a6ce2c2dbd01',
 0),  -- PROTO01

('b78366f8-8653-448a-8754-53a3135a2131',
 '{"EXTERNAL": {}, "CALCULATED": {}, "COLLECTED": {"TEXT": {"COLLECTED": "super réponse2"}}}'::jsonb,
 '0c83fb82-0197-7197-8e8c-a6ce2c2dbd02',
 0),  -- PROTO02

('b78366f8-8653-448a-8754-53a3135a2132',
 '{"EXTERNAL": {}, "CALCULATED": {}, "COLLECTED": {"TEXT": {"COLLECTED": "super réponse3"}}}'::jsonb,
 '0c83fb82-0197-7197-8e8c-a6ce2c2dbd03',
 0),  -- PROTO03

('b78366f8-8653-448a-8754-53a3135a2133',
 '{"EXTERNAL": {}, "CALCULATED": {}, "COLLECTED": {"TEXT": {"COLLECTED": "super réponse4"}}}'::jsonb,
 '0c83fb82-0197-7197-8e8c-a6ce2c2dbd04',
 0),  -- PROTO04

('b78366f8-8653-448a-8754-53a3135a2134',
 '{"EXTERNAL": {}, "CALCULATED": {}, "COLLECTED": {"TEXT": {"COLLECTED": "super réponse5"}}}'::jsonb,
 '0c83fb82-0197-7197-8e8c-a6ce2c2dbd05',
 0),  -- PROTO05

('b78366f8-8653-448a-8754-53a3135a2135',
 '{"EXTERNAL": {}, "CALCULATED": {}, "COLLECTED": {"TEXT": {"COLLECTED": "super réponse6"}}}'::jsonb,
 '0c83fb82-0197-7197-8e8c-a6ce2c2dbd06',
 0),  -- PROTO06

('b78366f8-8653-448a-8754-53a3135a2136',
 '{"EXTERNAL": {}, "CALCULATED": {}, "COLLECTED": {"TEXT": {"COLLECTED": "super réponse7"}}}'::jsonb,
 '0c83fb82-0197-7197-8e8c-a6ce2c2dbd07',
 0),  -- PROTO07

('b78366f8-8653-448a-8754-53a3135a2137',
 '{"EXTERNAL": {}, "CALCULATED": {}, "COLLECTED": {"TEXT": {"COLLECTED": "super réponse8"}}}'::jsonb,
 '0c83fb82-0197-7197-8e8c-a6ce2c2dbd08',
 0),  -- PROTO08

('b78366f8-8653-448a-8754-53a3135a2138',
 '{"EXTERNAL": {}, "CALCULATED": {}, "COLLECTED": {"TEXT": {"COLLECTED": "super réponse9"}}}'::jsonb,
 '0c83fb82-0197-7197-8e8c-a6ce2c2dbd09',
 0),  -- PROTO09

('b78366f8-8653-448a-8754-53a3135a2140',
 '{"EXTERNAL": {}, "CALCULATED": {}, "COLLECTED": {"TEXT": {"COLLECTED": "super réponse10"}}}'::jsonb,
 '0c83fb82-0197-7197-8e8c-a6ce2c2dbd10',
 0),  -- PROTO10

('b78366f8-8653-448a-8754-53a3135a2141',
 '{"EXTERNAL": {}, "CALCULATED": {}, "COLLECTED": {"TEXT": {"COLLECTED": "super réponse11"}}}'::jsonb,
 '0c83fb82-0197-7197-8e8c-a6ce2c2dbd11',
 0),  -- PROTO11

('b78366f8-8653-448a-8754-53a3135a2142',
 '{"EXTERNAL": {}, "CALCULATED": {}, "COLLECTED": {"TEXT": {"COLLECTED": "super réponse12"}}}'::jsonb,
 '0c83fb82-0197-7197-8e8c-a6ce2c2dbd12',
 0),  -- PROTO12

('b78366f8-8653-448a-8754-53a3135a2143',
 '{"EXTERNAL": {}, "CALCULATED": {}, "COLLECTED": {"TEXT": {"COLLECTED": "super réponse13"}}}'::jsonb,
 '0c83fb82-0197-7197-8e8c-a6ce2c2dbd13',
 0),  -- PROTO13

('b78366f8-8653-448a-8754-53a3135a2144',
 '{"EXTERNAL": {}, "CALCULATED": {}, "COLLECTED": {"TEXT": {"COLLECTED": "super réponse14"}}}'::jsonb,
 '0c83fb82-0197-7197-8e8c-a6ce2c2dbd14',
 0),  -- PROTO14

('b78366f8-8653-448a-8754-53a3135a2145',
 '{"EXTERNAL": {}, "CALCULATED": {}, "COLLECTED": {"TEXT": {"COLLECTED": "super réponse15"}}}'::jsonb,
 '0c83fb82-0197-7197-8e8c-a6ce2c2dbd15',
 0),  -- PROTO15

('b78366f8-8653-448a-8754-53a3135a2146',
 '{"EXTERNAL": {}, "CALCULATED": {}, "COLLECTED": {"TEXT": {"COLLECTED": "super réponse16"}}}'::jsonb,
 '0c83fb82-0197-7197-8e8c-a6ce2c2dbd16',
 0),  -- PROTO16

('b78366f8-8653-448a-8754-53a3135a2147',
 '{"EXTERNAL": {}, "CALCULATED": {}, "COLLECTED": {"TEXT": {"COLLECTED": "super réponse17"}}}'::jsonb,
 '0c83fb82-0197-7197-8e8c-a6ce2c2dbd17',
 0),  -- PROTO17

('b78366f8-8653-448a-8754-53a3135a2148',
 '{"EXTERNAL": {}, "CALCULATED": {}, "COLLECTED": {"TEXT": {"COLLECTED": "super réponse18"}}}'::jsonb,
 '0c83fb82-0197-7197-8e8c-a6ce2c2dbd18',
 0),  -- PROTO18

('b78366f8-8653-448a-8754-53a3135a2149',
 '{"EXTERNAL": {}, "CALCULATED": {}, "COLLECTED": {"TEXT": {"COLLECTED": "super réponse19"}}}'::jsonb,
 '0c83fb82-0197-7197-8e8c-a6ce2c2dbd19',
 0),  -- PROTO19

('b78366f8-8653-448a-8754-53a3135a2150',
 '{"EXTERNAL": {}, "CALCULATED": {}, "COLLECTED": {"TEXT": {"COLLECTED": "super réponse20"}}}'::jsonb,
 '0c83fb82-0197-7197-8e8c-a6ce2c2dbd20',
 0),  -- PROTO20

('b78366f8-8653-448a-8754-53a3135a2151',
 '{"EXTERNAL": {}, "CALCULATED": {}, "COLLECTED": {"TEXT": {"COLLECTED": "super réponse21"}}}'::jsonb,
 '0c83fb82-0197-7197-8e8c-a6ce2c2dbd21',
 0),  -- PROTO21

('b78366f8-8653-448a-8754-53a3135a2152',
 '{"EXTERNAL": {}, "CALCULATED": {}, "COLLECTED": {"TEXT": {"COLLECTED": "super réponse22"}}}'::jsonb,
 '0c83fb82-0197-7197-8e8c-a6ce2c2dbd22',
 0),  -- PROTO22

('b78366f8-8653-448a-8754-53a3135a2153',
 '{"EXTERNAL": {}, "CALCULATED": {}, "COLLECTED": {"TEXT": {"COLLECTED": "super réponse23"}}}'::jsonb,
 '0c83fb82-0197-7197-8e8c-a6ce2c2dbd23',
 0),  -- PROTO23

('b78366f8-8653-448a-8754-53a3135a2154',
 '{"EXTERNAL": {}, "CALCULATED": {}, "COLLECTED": {"TEXT": {"COLLECTED": "super réponse24"}}}'::jsonb,
 '0c83fb82-0197-7197-8e8c-a6ce2c2dbd24',
 0),  -- PROTO24

('b78366f8-8653-448a-8754-53a3135a2155',
 '{"EXTERNAL": {}, "CALCULATED": {}, "COLLECTED": {"TEXT": {"COLLECTED": "super réponse25"}}}'::jsonb,
 '0c83fb82-0197-7197-8e8c-a6ce2c2dbd25',
 0),  -- PROTO25

('b78366f8-8653-448a-8754-53a3135a2156',
 '{"EXTERNAL": {}, "CALCULATED": {}, "COLLECTED": {"TEXT": {"COLLECTED": "super réponse26"}}}'::jsonb,
 '0c83fb82-0197-7197-8e8c-a6ce2c2dbd26',
 0),  -- PROTO26

('b78366f8-8653-448a-8754-53a3135a2157',
 '{"EXTERNAL": {}, "CALCULATED": {}, "COLLECTED": {"TEXT": {"COLLECTED": "super réponse27"}}}'::jsonb,
 '0c83fb82-0197-7197-8e8c-a6ce2c2dbd27',
 0),  -- PROTO27

('b78366f8-8653-448a-8754-53a3135a2158',
 '{"EXTERNAL": {}, "CALCULATED": {}, "COLLECTED": {"TEXT": {"COLLECTED": "super réponse28"}}}'::jsonb,
 '0c83fb82-0197-7197-8e8c-a6ce2c2dbd28',
 0),  -- PROTO28

('b78366f8-8653-448a-8754-53a3135a2159',
 '{"EXTERNAL": {}, "CALCULATED": {}, "COLLECTED": {"TEXT": {"COLLECTED": "super réponse29"}}}'::jsonb,
 '0c83fb82-0197-7197-8e8c-a6ce2c2dbd29',
 0),  -- PROTO29

('b78366f8-8653-448a-8754-53a3135a2160',
 '{"EXTERNAL": {}, "CALCULATED": {}, "COLLECTED": {"TEXT": {"COLLECTED": "super réponse30"}}}'::jsonb,
 '0c83fb82-0197-7197-8e8c-a6ce2c2dbd30',
 0);  -- PROTO30
